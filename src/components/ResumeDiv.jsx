...
import ResumeModal from "./ui/Resume";
...
function ResumeDiv() {
  ...
  return (
    <>
      ...
      <div className="resume-div overflow-auto">
        <div className="bg-[#29292956] px-4 rounded-lg">
          <div className="flex justify-end pt-4 pb-3 static">
            {/* <ComponentToPrint ref={componentRef} /> */}
            
            <ReactToPrint
              trigger={() => <button className="mr-12"><i class="fa-solid fa-arrow-down mr-3"></i> Download</button>}
