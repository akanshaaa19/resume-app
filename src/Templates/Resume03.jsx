    ...
    >
      <div className="mb-8">
        <div className="flex items-center justify-between border-b-2 border-emerald-600 pb-2">
          <h1 className="text-4xl font-extrabold text-emerald-500 text-nowrap">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center pb-3">
          <h3 className=" text-xl tracking-wider  text-emerald-600">About</h3>
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center pb-3">
          <h3 className=" text-xl tracking-wider  text-emerald-600">Skills</h3>
          <div className="border-b-2 border-emerald-600 w-10/12" />
        </div>
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center pb-3">
          <h3 className=" text-xl tracking-wider  text-emerald-600">
            Education
          </h3>
      ...
      <div className="mb-6">
        ...
        {props.work.map((work) => {
          return (
            <div className="mb-3">
              <div className="flex justify-between font-medium">
                <h1>{work.title}</h1> <h1>2020-2022</h1>
              </div>
              <h2 className="text-sm pb-1">{work.org}</h2>
              <p>
                {work.desc}
              </p>
            </div>
