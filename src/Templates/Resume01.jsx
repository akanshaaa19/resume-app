  ...
  return (
    <section ref = {ref} className="bg-white text-black rounded-lg px-8 py-24" id="resume">
      ...
      <div className="row mb-8">
        <div className="col-6">
          <h1 className="text-4xl font-extrabold text-blue-900 text-nowrap">
          {props.personalDetails.name}
          </h1>
          <h3 className="text-slate-500 text-2xl">{props.personalDetails.designation}</h3>
        </div>
        <div className="col-6 text-right"></div>
      </div>
      <div className="row justify-between pb6">
        <div className=" col-3">
          <h1 className="text-2xl font-bold text-blue-900">About</h1>
        </div>
        <div className=" col-8">
      ...
      <div className="row justify-between">
        <div className=" col-3">
          <h1 className="text-2xl font-bold text-blue-900">Education</h1>
        </div>
        <div className=" col-8">
      ...
      <div className="row justify-between">
        <div className=" col-3">
          <h1 className="text-2xl font-bold text-blue-900">Expirience</h1>
        </div>
        <div className=" col-8">
      ...
      <div className="row justify-between pb6">
        <div className=" col-3">
          <h1 className="text-2xl font-bold text-blue-900">Skills</h1>
        </div>
        <div className="col-8">
          <div className="border-b-2 py-4 border-slate-300">
